...
function ct_custom_scripts() {
    ...
    // Homepage custom styles (only if file exists)
    if ( file_exists( get_template_directory() . '/style-homepage.css' ) ) {
        wp_enqueue_style( 'ct-custom-homepage-style', get_template_directory_uri() . '/style-homepage.css', array(), filemtime( get_template_directory() . '/style-homepage.css' ) );
    }
    ...
    // Menu toggle for responsive menu
    if ( file_exists( get_template_directory() . '/menu-toggle.js' ) ) {
        wp_enqueue_script( 'ct-custom-menu-toggle', get_template_directory_uri() . '/menu-toggle.js', array('jquery'), filemtime( get_template_directory() . '/menu-toggle.js' ), true );
    }

    // Load comment-reply script only if needed
